...
pub const GRAMMAR: &str = "crates/codira_syntax/src/grammar.ron";
pub const SYNTAX_KINDS: &str = "crates/codira_syntax/src/syntax_kind/generated.rs.tera";
pub const AST: &str = "crates/codira_syntax/src/ast/generated.rs.tera";
