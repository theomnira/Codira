...
use super::{
    ...
    SyntaxKind::{
        ...
        OPTIONAL_TYPE, PARAM, PARAM_LIST, PAREN_EXPR, PAREN_TYPE, PATH, PATH_EXPR, PATH_PAT,
        PATH_SEGMENT, PATH_TYPE, PERFORM_EXPR, PLACEHOLDER_PAT, PREFIX_EXPR, RECORD_FIELD,
        RECORD_FIELD_DEF, RECORD_FIELD_DEF_LIST, RECORD_FIELD_LIST, RECORD_LIT, REFINEMENT_TYPE,
        ...
        TUPLE_STRUCT_PAT, TUPLE_TYPE, TYPE_ALIAS_DEF, USE, USES_CLAUSE, USE_TREE, USE_TREE_LIST,
        VISIBILITY, WHERE_CLAUSE, WHERE_PRED, WHILE_EXPR,
    },
};
