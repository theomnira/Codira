...
pub(crate) fn emit_hir_diagnostic(
    diagnostic: &dyn codira_hir::Diagnostic,
    db: &impl HirDatabase,
    file_id: FileId,
    display_colors: bool,
    writer: &mut dyn std::io::Write,
...
fn emit_diagnostic(
    diagnostic: &dyn codira_diagnostics::Diagnostic,
    db: &impl HirDatabase,
    file_id: FileId,
    display_colors: bool,
    writer: &mut dyn std::io::Write,
    ...
    struct AnnotationFile {
        ...
        annotations: Vec<codira_diagnostics::SourceAnnotation>,
    }
    ...
    let annotations = {
        ...
        annotations.push(AnnotationFile {
            ...
            annotations: vec![match diagnostic.primary_annotation() {
                None => codira_diagnostics::SourceAnnotation {
                    range,
                    message: title.clone(),
                },
