...
pub(super) fn render_field(ctx: RenderContext<'_>, field: codira_hir::Field) -> CompletionItem {
...
impl<'a> Render<'a> {
    ...
    fn render_resolution(
        ...
        use codira_hir::ModuleDef::{Function, Module, PrimitiveType, Struct, TypeAlias};
    ...
    fn render_field(&mut self, field: codira_hir::Field) -> CompletionItem {
