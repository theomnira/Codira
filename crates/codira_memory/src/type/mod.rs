...
/// A linked version of [`codira_abi::TypeInfoData`] that has resolved all
...
/// A linked version of [`codira_abi::StructInfo`] that has resolved all
/// occurrences of `TypeId` with `TypeInfo`.
#[derive(Clone, Debug)]
struct StructData {
...
/// A linked version of [`codira_abi::PointerInfo`] that has resolved all
/// occurrences of `TypeId` with `TypeInfo`.
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
struct PointerData {
...
pub struct FieldData {
    ...
    // const CodiraPrivacy_t *field_privacies,
}
