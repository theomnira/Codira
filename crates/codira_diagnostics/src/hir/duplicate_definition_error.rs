...
/// }
/// ```
pub struct DuplicateDefinition<'db, 'diag, DB: codira_hir::HirDatabase> {
    db: &'db DB,
    diag: &'diag codira_hir::diagnostics::DuplicateDefinition,
}

impl<DB: codira_hir::HirDatabase> Diagnostic for DuplicateDefinition<'_, '_, DB> {
...
impl<DB: codira_hir::HirDatabase> DuplicateDefinition<'_, '_, DB> {
...
impl<'db, 'diag, DB: codira_hir::HirDatabase> DuplicateDefinition<'db, 'diag, DB> {
    /// Constructs a new instance of `DuplicateDefinition`
    pub fn new(db: &'db DB, diag: &'diag codira_hir::diagnostics::DuplicateDefinition) -> Self {
