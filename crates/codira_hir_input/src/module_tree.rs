...
/// instance for the relative path `foo/bar/baz.code`, besides the module
...
mod test {
    ...
    fn module_path() {
        assert_eq!(
            path_to_module_path(RelativePath::new("foo/bar/baz.code")),
            vec!["foo", "bar", "baz"]
        );
        assert_eq!(
            path_to_module_path(RelativePath::new("foo/bar/mod.code")),
            vec!["foo", "bar"]
        );
        assert_eq!(
            path_to_module_path(RelativePath::new("foo/mod.code")),
            vec!["foo"]
        );
        assert_eq!(
            path_to_module_path(RelativePath::new("foo.code")),
            vec!["foo"]
        );
        assert_eq!(
            path_to_module_path(RelativePath::new("mod.code")),
            Vec::<String>::new()
        );
    }
